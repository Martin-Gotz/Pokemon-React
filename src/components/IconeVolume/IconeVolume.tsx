    ...
    return (
        <div className={"icone-volume"} onClick={toggleMuet}>
            {!muet ? (
                ...
                <svg className={"svg-volume"} width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                    <path d="m0,0l24,0l0,24l-24,0l0,-24z" fill="none" id="svg_1"/>
                    <path d="m3,9l0,6l4,0l5,5l0,-16l-5,5l-4,0zm13.5,3c0,-1.77 -1.02,-3.29 -2.5,-4.03l0,8.05c1.48,-0.74 2.5,-2.26 2.5,-4.02zm-2.5,-8.77l0,2.06c2.89,0.76 5,3.49 5,6.71s-2.11,5.95 -5,6.71l0,2.06c4.06,-0.92 7,-4.48 7,-8.77s-2.94,-7.85 -7,-8.77z" id="svg_2"/>
